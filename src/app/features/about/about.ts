...
export class AboutPage {
  ...
  approach = [
    {
      title: 'Community-Led',
      description: 'Projects are shaped by the people they serve, not designed in isolation from them.',
    },
    {
      title: 'Transparent',
      description: 'Every project shows its target, what\u2019s been raised, and where funds go — see our Transparency page.',
    },
    {
      title: 'Sustainable',
      description: 'We favour lasting change — education and sponsorship over one-off handouts wherever possible.',
    },
    {
      title: 'Rooted in Knowledge',
      description: 'Every initiative is grounded in authentic Islamic teaching and guided by qualified scholarship.',
    },
  ];

  coreValues: CoreValue[] = [
    { title: 'Knowledge', description: 'Seeking and sharing authentic Islamic understanding.', icon: 'ai-book' },
    { title: 'Sincerity', description: 'Acting for the sake of Allah, before recognition or reward.', icon: 'ai-heart' },
    { title: 'Compassion', description: 'Meeting people\u2019s hardship with mercy, not judgement.', icon: 'ai-hand-heart' },
    { title: 'Service', description: 'Putting the needs of the community before our own convenience.', icon: 'ai-users' },
    { title: 'Integrity', description: 'Doing what\u2019s right even when no one is watching.', icon: 'ai-shield' },
    { title: 'Community', description: 'Stronger together — no project succeeds alone.', icon: 'ai-globe' },
    { title: 'Excellence', description: "Doing every project as if it were an act of worship — because it is.", icon: 'ai-star' },
  ];
